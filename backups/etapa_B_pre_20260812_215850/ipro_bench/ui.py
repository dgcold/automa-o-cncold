...
class MainWindow(QMainWindow):
    ...
    def _supervision(self) -> QWidget:
        page, layout = self._page()
        layout.addWidget(QLabel("Sensores · iPro AGUARDANDO MAPA OFICIAL", objectName="title"))
    ...
    def _io_page(self) -> QWidget:
        ...
        layout.addWidget(QLabel("VX-1050E · AGUARDANDO MAPA OFICIAL · somente leitura", objectName="muted"))
        rows = (
